...
class VerificationRepository(BaseRepository[VerificationCode]):
    ...
    def create_verification(self,verification:VerificationCode) -> VerificationCode:
        ...
        return verification
    def get_otp_verification(self, employee_id:int, verification_type: VerificationTypeEnum) -> Optional[VerificationCode]:
    ...
    def get_valid_otp(self,employee_id:int, code:str, verification_type: VerificationTypeEnum) -> Optional[VerificationCode]:
        """Get valid OTP """
        now = datetime.now(timezone.utc)
        return (
