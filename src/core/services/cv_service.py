# src/core/services/cv_service.py (Fixed)
...
class CVService:
    ...
    def get_cvs(self, skip: int = 0, limit: int = 100) -> List:
    ...
    def update_cv(self, cv_id: str, cv_update: CVUpdate):
        """Update a CV"""
    ...
    def search_cvs(self, 
        ...
        from src.core.models.cv import CV, TechnicalSkill
