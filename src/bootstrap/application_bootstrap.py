...
class ApplicationBootstrap:
            ...
            if db_healthy:
                try:
                    ...
                    try:
                        ...
                        health_status["stats"] = {"error": f"Could not get stats: {str(e)}"}
                    finally:
                        db.close()
                except Exception:
                    pass
    ...
    def shutdown(self):
        ...
        # Database connections are managed by database_bootstrap
        # No additional cleanup needed for simplified version
